...
class IOSVPNService {
  ...
  static Future<bool> startVPN({
    ...
    if (!isIOS) {
      debugPrint('[iOS VPN] Not running on iOS platform');
      return false;
    }

    try {
      debugPrint('[iOS VPN] Starting VPN...');
      debugPrint('[iOS VPN] Server: $serverAddress');
      ...
      debugPrint('[iOS VPN] Start result: $result');
      return result == true;
    } on PlatformException catch (e) {
      debugPrint('[iOS VPN] Failed to start VPN: ${e.code} - ${e.message}');
      return false;
    } catch (e) {
      debugPrint('[iOS VPN] Unexpected error: $e');
      return false;
    }
  }
  ...
  static Future<bool> stopVPN() async {
    ...
    try {
      debugPrint('[iOS VPN] Stopping VPN...');

      final result = await platform.invokeMethod('stopVPN');

      debugPrint('[iOS VPN] Stop result: $result');
      return result == true;
    } on PlatformException catch (e) {
      debugPrint('[iOS VPN] Failed to stop VPN: ${e.code} - ${e.message}');
      return false;
    } catch (e) {
      debugPrint('[iOS VPN] Unexpected error: $e');
      return false;
  ...
  static Future<Map<String, dynamic>?> getVPNStatus() async {
    ...
    try {
      ...
      debugPrint(
          '[iOS VPN] Failed to get VPN status: ${e.code} - ${e.message}');
      return null;
    } catch (e) {
      debugPrint('[iOS VPN] Unexpected error: $e');
      return null;
  ...
  static Future<bool> saveConfig({
    ...
    try {
      debugPrint('[iOS VPN] Saving configuration...');
      ...
      debugPrint('[iOS VPN] Save result: $result');
      return result == true;
    } on PlatformException catch (e) {
      debugPrint('[iOS VPN] Failed to save config: ${e.code} - ${e.message}');
      return false;
    } catch (e) {
      debugPrint('[iOS VPN] Unexpected error: $e');
      return false;
